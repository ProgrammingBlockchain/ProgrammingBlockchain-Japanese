# Key generation and encryption鍵生成と暗号化 {#key-generation-encryption}

## Is it random enough?それは十分にランダムだろうか？ {#is-it-random-enough}
...
iOS上では、私はまだ実装したことはないが、**IRandom** の実装クラスを作る必要がある。
